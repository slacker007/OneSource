...
- The post-completion Material UI program is complete through `MUI-17`. The design-reset follow-up is now active: the shared theme, shell, and dashboard use the new compact neutral baseline, and later route-family slices will keep removing remaining hybrid layout composition.
