...
- The post-completion Material UI refactor program is now active. `MUI-01` establishes the root MUI foundation, `MUI-02` establishes the shared wrapper layer and first live route migration on `/sign-in`, and `MUI-03` through `MUI-14` remain queued in `PRD.md` and GitHub epic `#15`.
