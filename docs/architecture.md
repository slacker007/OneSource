...
- Typed entity DTOs, repository functions, opportunity-workspace mapping, personal-task-board mapping, stage-policy rules, form-validation helpers, and audited write-service integration now live in `src/modules/opportunities`.
