...
23. The guarded settings route at [src/app/(app)/settings/page.tsx](</Users/maverick/Documents/RalphLoops/OneSource/src/app/(app)/settings/page.tsx:1>) calls [requireAppPermission](/Users/maverick/Documents/RalphLoops/OneSource/src/lib/auth/authorization.ts:1), loads organization-scoped admin data plus the seeded scoring profile, recalibration snapshot, and source-operations snapshot through [src/modules/admin/admin.repository.ts](/Users/maverick/Documents/RalphLoops/OneSource/src/modules/admin/admin.repository.ts:1), wires the guarded retry and recalibration mutations through [src/app/(app)/settings/actions.ts](</Users/maverick/Documents/RalphLoops/OneSource/src/app/(app)/settings/actions.ts:1>), and renders [AdminConsole](/Users/maverick/Documents/RalphLoops/OneSource/src/components/admin/admin-console.tsx:1) as an ops-focused workspace without embedding the user-role registry.
24. The guarded `/settings/users` route at [src/app/(app)/settings/users/page.tsx](</Users/maverick/Documents/RalphLoops/OneSource/src/app/(app)/settings/users/page.tsx:1>) uses the same permission boundary, loads a dedicated organization-scoped user-management snapshot from [src/modules/admin/admin.repository.ts](/Users/maverick/Documents/RalphLoops/OneSource/src/modules/admin/admin.repository.ts:1), wires audited invite or role-update or disable or re-enable mutations through [src/app/(app)/settings/users/actions.ts](</Users/maverick/Documents/RalphLoops/OneSource/src/app/(app)/settings/users/actions.ts:1>) plus [src/modules/admin/user-management.service.ts](/Users/maverick/Documents/RalphLoops/OneSource/src/modules/admin/user-management.service.ts:1), and renders [AdminUserManagement](/Users/maverick/Documents/RalphLoops/OneSource/src/components/admin/admin-user-management.tsx:1) on top of the shared MUI `DataGrid`, badge, form, dialog, and feedback primitives.
25. Non-admin users who navigate directly to either `/settings` or `/settings/users` are redirected to `/forbidden`.
25. The health route at [src/app/api/health/route.ts](/Users/maverick/Documents/RalphLoops/OneSource/src/app/api/health/route.ts:1) now calls [src/lib/runtime-health.ts](/Users/maverick/Documents/RalphLoops/OneSource/src/lib/runtime-health.ts:1), logs the result through [src/lib/observability/logger.ts](/Users/maverick/Documents/RalphLoops/OneSource/src/lib/observability/logger.ts:1), and returns either `200 ok` or `503 degraded` with database plus document-storage readiness details.
