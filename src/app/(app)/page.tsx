        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div className="space-y-2">
            ...
            <p className="text-muted max-w-3xl text-sm leading-7 sm:text-base">
              The landing page now surfaces the attention queue, top pursuits,
              task load, pipeline pressure, and recent source activity directly
              from the typed repository snapshot.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3 lg:items-end">
            <div className="flex flex-wrap gap-3">
              <Link
                className="inline-flex min-h-11 items-center justify-center rounded-full bg-[rgb(19,78,68)] px-4 py-2.5 text-sm font-semibold text-white shadow-[0_14px_30px_rgba(19,78,68,0.18)] transition hover:bg-[rgb(16,66,57)]"
                href="/opportunities?due=next_30_days"
              >
                Review deadline queue
              </Link>
              <Link
                className="text-foreground inline-flex min-h-11 items-center justify-center rounded-full border border-[rgba(15,28,31,0.12)] bg-white px-4 py-2.5 text-sm font-semibold transition hover:bg-slate-50"
                href="/tasks"
              >
                Open task triage
              </Link>
