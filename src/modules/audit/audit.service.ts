...
export const AUDIT_ACTIONS = {
  ...
  opportunityProposalCreate: "opportunity.proposal.create",
  opportunityProposalUpdate: "opportunity.proposal.update",
  opportunityProposalDelete: "opportunity.proposal.delete",
  ...
  workspaceUserCreate: "workspace_user.create",
  workspaceUserDisable: "workspace_user.disable",
  workspaceUserReactivate: "workspace_user.reactivate",
  workspaceUserRolesUpdate: "workspace_user.roles.update",
