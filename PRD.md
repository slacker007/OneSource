...
- [ ] UI-02 Build the reusable interaction primitives required by the redesign, including the upgraded data table, filter-chip bar, saved-view controls, preview panel or drawer pattern, density toggle, and loading skeleton patterns.
