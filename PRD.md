...
- Current status: `P0-01`, `P0-02`, `P0-02a`, `P0-03`, `P0-04`, `P1-01`, `P1-02`, `P1-02a`, `P1-03`, `P1-04`, `P1-05`, `P2-01`, `P2-02`, `P2-03`, `P2-04`, `P3-01`, `P3-02`, `P3-03`, `P4-01`, `P4-01a`, `P4-01b`, `P4-02`, `P4-03`, `P4-04`, `P5-01`, `P5-02`, `P5-03`, `P5-04`, `P6-01`, and `P6-02` are complete. This loop added a pure deterministic scoring engine under `src/modules/opportunities/` that evaluates capability fit, strategic alignment, vehicle access, relationship strength, schedule realism, and risk from the seeded organization profile plus opportunity metadata, then wired the repository to synthesize scorecards for list and workspace snapshots whenever a persisted current scorecard is missing so every opportunity can still produce a normalized factor breakdown.
- Next recommended item: `P6-03 Implement go/no-go recommendation logic that combines score, risk, and configurable thresholds.`
- Blockers: No product blocker for `P6-03`. Unrelated repo sync blocker remains: the earlier local history rewrite still has not been force-pushed to `origin` from this environment because the remote is SSH-based and this runtime lacks an authenticated SSH path.
- Files touched in latest loop: `NOTES.md`, `PRD.md`, `README.md`, `docs/architecture.md`, `docs/testing.md`, `src/components/opportunities/opportunity-workspace.tsx`, `src/modules/opportunities/opportunity-scoring.ts`, `src/modules/opportunities/opportunity-scoring.test.ts`, `src/modules/opportunities/opportunity.repository.ts`, and `src/modules/opportunities/opportunity.repository.test.ts`.
- Tests run in latest loop: `npm test -- src/modules/opportunities/opportunity-scoring.test.ts src/modules/opportunities/opportunity.repository.test.ts src/components/opportunities/opportunity-workspace.test.tsx`; `npm run lint`; `npm run build`; `docker compose up -d db`; `npm run prisma:validate`; `npm run db:seed`; `npm test`; `npm run build`; `npm run e2e`; `make compose-test-lint`; `make compose-test`; `make compose-test-build`; `make compose-test-e2e`; `make compose-down`; and `git diff --check`. Verification used Docker and Playwright.
